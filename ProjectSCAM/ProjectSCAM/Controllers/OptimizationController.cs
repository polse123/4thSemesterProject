...
namespace ProjectSCAM.Controllers
{
    ...
    public class OptimizationController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                List<BatchModel> SortedList = ServiceSingleton.Instance.DBService.RetrieveBatches(true).OrderBy(o => o.Speed).ToList();
        ...
        public ActionResult GetBatchesByRecipe(string recipe)
        {
            ...
            if (add)
            {
                list = ServiceSingleton.Instance.DBService.RetrieveBatchesByRecipe(intProductType, true);
            }
